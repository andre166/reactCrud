...
export default function AddContato() {
    ...
    function gerarId(){
        ...
        let ultimo = contactsArray[contactsArray.length - 1 ]; //Pega o id contato da última posição do array soma +1 e adiciona ao id do novo contato
        
        register(++ultimo.id);
        
    }
    
    function register(id) {// recebe o ID gerado e adiciona ao novo contato
        ...
        contactsArray.unshift(newContact); //coloca o contato na primeira posição do array
        
        localStorage.setItem("ListaDeContatos", JSON.stringify(contactsArray));
        localStorage.setItem("MSG", "CadastradoSuccess"); // msg para a snackBar 
            ...
            <div className="card card-body mt-2 ">
                ...
                <form onSubmit={gerarId} action={  `/ListaDeContatos`  }>
                    ...
                    <div className="text-center">
                        ...
                        <button class="btn btn-softGreen-escuro mt-2" type="submit">Cadastrar</button>
                    </div>
                </form>
